...
{
    public partial class WichitaViewModel:ObservableObject
    {
        HttpClient _client;
        public WichitaViewModel()
        {
        ...
        {
            var W_API = "https://localhost:7151/CityStats";
            ...
            for(int i = 0; i < jsonRes.daily.time.Count; i++)
            {
                ...
                Weathercode.Add(x);
                //Weathercode.Add(jsonRes.daily.weathercode[i]);
